...
func main() {
	...
	navi, _ := navigator.NewAnyPathNavigator(pathOnSphere)

	for navi.NextLocation() {
	...
	navi2d, _ := navigator.NewAnyPathNavigator(path2d)

	for navi2d.NextLocation() {
	...
	navi3d, _ := navigator.NewAnyPathNavigator(path3d)

	for navi3d.NextLocation() {
